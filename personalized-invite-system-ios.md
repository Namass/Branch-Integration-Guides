...
Please visit [dev.branch.io](https://dev.branch.io/recipes/personalized_welcome/) for the most up to date version of this guide and other learning resources for Branch.
{% endhighlight %}
