...
Please visit [dev.branch.io](https://dev.branch.io/recipes/content_sharing/) for the most up to date version of this guide and other learning resources for Branch.
{% endhighlight %}
...
For iOS, you need to add it to YourProject-Info.plist (Info.plist for Swift). Create a key called branch_key, with string value: **YOUR_BRANCH_KEY**. Here are [instructions with graphics](https://github.com/BranchMetrics/Branch-Integration-Guides/blob/master/ios-quickstart.md#add-your-branch-key-to-your-project).
