...
Please visit [dev.branch.io](https://dev.branch.io/recipes/content_sharing/ios/) for the most up to date version of this guide and other learning resources for Branch.
{% endhighlight %}
